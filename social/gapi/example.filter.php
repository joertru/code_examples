<?php
define('ga_email','joertru@gmail.com');
define('ga_password','pbitpwcjuessdvnv');
define('ga_profile_id','1892302');
...
$filter = 'country == Colombia && browser == Firefox || browser == Chrome';
